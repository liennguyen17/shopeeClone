...
// xử lý lấy price_max,price_min từ schema
    ...
    <div className='py-4'>
      ...
      <Link to={path.home} className='flex items-center font-bold mt-4 uppercase'>
        <svg
          ...
          x={0}
          y={0}
          className='w-3 h-4 fill-current stroke-current'
        >
          <g>
            <polyline
              fill='none'
      ...
      <div className='my-5'>
        ...
        <form className='mt-2' onSubmit={onSubmit}>
          ...
          <div className='mt-1 text-center text-red-600 min-h-[1.25rem] text-sm'>{errors.price_min?.message}</div>
