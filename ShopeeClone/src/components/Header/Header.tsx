        ...
        <div className='flex justify-end'>
          ...
          {isAuthenticated && (
            <Popover
              ...
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                  <Link to={path.profile} className='block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500'>
                    Tài khoản của tôi
                  </Link>
            ...
            >
              <div className='w-6 h-6 mr-2 flex-shrink-0'>
                <img
                  src='https://down-vn.img.susercontent.com/file/sg-11134004-23010-wmmbc7bz7vlvc5_tn'
                  alt='avatar'
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lh34j7igr01fea_tn'
                            alt='anh'
                            className='w-11 h-11 object-cover'
                          />
                        </div>
                        {/* truncate: neu ten dai thi no se ...  ket hop voi overflow-hidden*/}
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            Siêu Son Dưỡng Có Màu Thuần Chay Môi Nhạy Cảm Glamrr Q Vega n Super Lip Balm (4.5g)
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫199.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
